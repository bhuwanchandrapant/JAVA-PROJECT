			...
			<div class="row">
				<div class="col-sm-6 col-xs-12">
					<ul class="contact_details">
						<li class="fromleft wow" data-wow-delay=".3s"><span
							class="icons"> <i class="fa fa-envelope-open-o"
								aria-hidden="true"></i>
						</span>
							<div>
								<h3>Our Email</h3>
								<p>
									<strong>Help :</strong> info@yourmail.com
								</p>
								<p>
									<strong>Support :</strong> Support@yourmail.com
								</p>
							</div></li>
						<li class="fromleft wow" data-wow-delay=".6s"><span
							class="icons"> <i class="fa fa-phone" aria-hidden="true"></i>
						</span>
							<div>
								<h3>Our Phone</h3>
								<p>
									<strong>Office Phone :</strong> +1-202-555-0145
								</p>
								<p>
									<strong>Mobile :</strong> 202-555-0168
								</p>
							</div></li>
						<li class="fromleft wow" data-wow-delay=".9s"><span
							class="icons"> <i class="fa fa-map-marker"
								aria-hidden="true"></i>
						</span>
							<div>
								<h3>Our Address</h3>
								<p>
									<strong>Office Address 1 :</strong> 2285 Memory Ln, Germanton,
									NC, 27019
								</p>
								<p>
									<strong>Office Address 2 :</strong> 5124 Fong Dr, Copperopolis,
									CA, 95228
								</p>
							</div></li>
					</ul>
						...
						<div class="row">
							...
							<form action="Enquiry" method="post">
								<div class="col-md-6 col-xs-12">
									<input type="text" pattern="[A-z]{1,15}" placeholder="Your name"  required="required" name="name">
								</div>
								<div class="col-md-6 col-xs-12">
									<input type="text" placeholder="Your Email" pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$"  required="required" name="email">
								</div>
								<div class="col-md-6 col-xs-12">
									<input type="text" placeholder="Your Phone" maxlength="10" pattern="^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$" required="required" name="contact">
								</div>
								<div class="col-md-6 col-xs-12">
									<input type="date"  name="date" required="required" placeholder="Date off Birthdate">
								</div>
								<div class="col-md-6 col-xs-12">
								...
								<div class="col-lg-12 col-xs-12">
									<button type="submit" class="submit_btn red_btn">Join
										Now</button>
								</div>
