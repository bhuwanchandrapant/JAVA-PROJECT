                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body" id="carditem">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Instructor</span>
                                                <h4 class="mb-3">
									...
									%>
                                            ...
                                            <div class="col-6">
                                                 <i class=" fas fa-users" style="font-size: 32px; padding-left: 40px; color: #5156be;"></i>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                           ...
                           <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100" >
                                    ...
                                    <div class="card-body" id="carditem">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Plan</span>
                                                <h4 class="mb-3">
                                                    <%
										try
										{
											...
											Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/driving_school","root","");
											Statement st=con.createStatement();
											String strQuery = "SELECT COUNT(*) FROM pricing";
											ResultSet rs = st.executeQuery(strQuery);
											String Countrow="";
											while(rs.next()){
											Countrow = rs.getString(1);
									...
									%>
                                            ...
                                            <div class="col-6">
                                                 <i class="fas fa-box-open" style="font-size: 32px; padding-left: 40px; color: #5156be;"></i>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body" id="carditem">
										...
										try
										{
											...
											Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/driving_school","root","");
											Statement st=con.createStatement();
											String strQuery = "SELECT COUNT(*) FROM courses";
											ResultSet rs = st.executeQuery(strQuery);
											String Countrow="";
											while(rs.next()){
											Countrow = rs.getString(1);
									...
									%>
                                            ...
                                            <div class="col-6">
                                                 <i class="fas fa-shopping-cart" style="font-size: 32px; padding-left: 40px; color: #5156be;"></i>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                         ...
                         <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body" id="carditem">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">View Enquiry</span>
                                                <h4 class="mb-3">
                                                     <%
										try
										{
									...
									%>
                                            ...
                                            <div class="col-6">
                                                 <i class=" fas fa-comment-dots" style="font-size: 32px; padding-left: 40px; color:#5156be;"></i>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
