						...
						<div class="row">
							...
							<form action="newPassword" method="post">
								...
								<div class="col-md-6 col-xs-12">
									<input type="password" placeholder="Enter NewPassword"  required="required" name="password">
								</div>
								
								<div class="col-md-6 col-xs-12">
									<input type="password" placeholder="Enter ConfirmPassword"  required="required" name="confPassword">
								</div>
								
								
									
								<div class="col-lg-12 col-xs-12">
									<button type="submit" class="submit_btn red_btn">Reset Password</button>
