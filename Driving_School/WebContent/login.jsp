						...
						<div class="row">
							...
							<form action="UserLogin" method="post">
								...
								<div class="col-md-6 col-xs-12">
									<input type="text" placeholder="Your Username & Email" required="required" name="name">
								</div>
								
								<div class="col-md-6 col-xs-12">
									<input type="password" placeholder="Your Password"  required="required" name="password">
								</div>
								
								
									
								<div class="col-lg-12 col-xs-12">
									<button type="submit" class="submit_btn red_btn">Login
										Now</button><br>
