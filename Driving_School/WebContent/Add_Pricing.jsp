		...
		<div class="main-content">
			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							<div
								...
								<h4 class="mb-sm-0 font-size-18">Add Pricing</h4>
					...
					<form action="Savepricing" method="post"
												...
												<div>
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Courses
															Name:</label> <select name="coursename" required="required" class="form-control">
																<option value="" disabled hidden selected>Choose Courses</option>
													...
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Price:
															</label> <input type="text" maxlength="5" pattern="^[0-5]{1,5}$" required="required" class="form-control"
															name="price" id="example-product_name-input"><br>
													</div>												</div>
											</div>
											<div class="col-lg-6">
												<div class="mt-2 mt-lg-0">
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Plan:
															</label> <select name="plan" required="required" class="form-control">
															<option value="" disabled hidden selected>Choose Plan</option>
