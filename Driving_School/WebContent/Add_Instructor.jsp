										...
										<div class="row">
												...
												<div>
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Instructor
															Name:</label> <input type="text" class="form-control" pattern="[A-z]{1,60}"
															name="name" id="example-product_name-input" required="required"><br>
													</div>
													<div class="mb-3">
											...
											<div class="col-lg-6">
												<div class="mt-2 mt-lg-0">
													...
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Instructor
															Details:</label> <input type="text" maxlength="60" pattern="[A-Za-z \s]{1,60}" class="form-control"
															name="detail" required="required" id="example-product_name-input"><br>
													</div>
												</div>
											</div>
