			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<% 
 		            	...
 		            	List<Courses>list =dao.viewCourses();
							...
							<div class="card">
								<div class="card-body">
									<table id="datatable-buttons"
										...
										<tbody>
											<c:forEach var="cou" items="${cou}">
												<tr>
													<td id="id"></td>
													<td>${cou.courses}</td>
													<td>${cou.time}</td>
													<td>${cou.price}</td>
													<td><img src="images/instructors/${cou.image}"
														style="height: 30px; width: 60px;"></td>
														
													<td align="center"><a href="EditCourses?id=${cou.id}"><i
															class="fa fa-edit" style="font-size: 18px"></i></a></td>
															
													<td align="center"><a
														href="DeleteCourses?id=${cou.id}"><i
