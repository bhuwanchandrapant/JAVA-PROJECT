			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<%
						...
						session.setAttribute("i", list);
					%>

					<form action="EditInst" method="post"
										...
										<div class="row">
											<div class="col-lg-6">
												<div>
													...
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Instructor
															Name:</label>
															<input type="hidden" name="id" value="${list.id}">
															 <input type="text" class="form-control" pattern="[A-z]{1,15}"
															name="name" value="${list.name}" id="example-product_name-input" required="required" ><br>
													</div>
													<div class="mb-3">
														<label for="example-image-input" class="form-label">Instructor Image
															:</label> <input class="form-control" type="file" required="required" name="image" value="<c:out value="${list.profile}"></c:out>" 
															accept="image/*" onchange="loadFile(event)">
															<input type="hidden" value="${list.profile}" name="image">
											...
											<div class="col-lg-6">
												<div class="mt-2 mt-lg-0">
													...
													<div class="mb-2">
														<label for="example-product_name-input" class="form-label">Instructor
															Details:</label> <input type="text" maxlength="60" class="form-control"
															name="detail" value="${list.detail}" required="required" id="example-product_name-input" ><br>
													</div>
												</div>
											</div>
