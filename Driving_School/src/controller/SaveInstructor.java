 ...
 */
@MultipartConfig
@WebServlet("/SaveInstructor")
public class SaveInstructor extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("swal('Add Instructor Submitted Successfull','','success');");
        out.println("});");
        out.println("</script>");
        RequestDispatcher rd=request.getRequestDispatcher("Add_Instructor.jsp");
